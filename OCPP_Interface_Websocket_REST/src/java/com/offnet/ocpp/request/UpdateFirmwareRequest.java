...
public class UpdateFirmwareRequest extends Request{
    ...
    public UpdateFirmwareRequest(JsonObject json) {
        ...
        setRetrieveDate(Utilities_Websocket.formatCalendar(json.get("retrieveDate").getAsString()));
        
        if(Utilities_Websocket.checkNull(json, "retries")) { 
            setRetries(json.get("retries").getAsInt());
        }
        
        if(Utilities_Websocket.checkNull(json, "retryInterval")) { 
    ...
    public String toJson() {
        ...
        Utilities_Websocket.addToJSON(response, "location", getLocation(), false);
        Utilities_Websocket.addToJSON(response, "retrieveDate",  Utilities_Websocket.formatData(getRetrieveDate()), false);
        Utilities_Websocket.addToJSON(response, "retries", getRetries(), true);
        Utilities_Websocket.addToJSON(response, "retryInterval", getRetryInterval(), true);
