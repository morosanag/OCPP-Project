...
public class GetDiagnosticsRequest extends Request{
    ...
    public GetDiagnosticsRequest (JsonObject json) {
        ...
        if(json.has("startTime")) {
            setStartTime(Utilities_Business.formatCalendar(json.get("startTime").getAsString()));
        }
        if(json.has("stopTime")) {
            setStopTime(Utilities_Business.formatCalendar(json.get("stopTime").getAsString()));
        }
    ...
    public String toJson() {
        ...
        Utilities_Business.addToJSON(obj, "location", getLocation(), false);
        Utilities_Business.addToJSON(obj, "retries", getRetries(), true);
        Utilities_Business.addToJSON(obj, "retryInterval", getRetryInterval(), true);
        Utilities_Business.addToJSON(obj, "startTime", Utilities_Business.formatData(getStartTime()), true);
        Utilities_Business.addToJSON(obj, "stopTime", Utilities_Business.formatData(getStopTime()), true);
