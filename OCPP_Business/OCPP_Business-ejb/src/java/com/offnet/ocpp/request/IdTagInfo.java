...
public class IdTagInfo {
    ...
    */
    ...
    public String toString() {
        ...
        str += "'expiryDate' : " + getExpiryDate() + ", ";
        str += "'parentIdTag' : " + getParentIdTag() + " }";
        return str;
    }
    ...
    public JsonObject toJson() {
        ...
        json.addProperty("expiryDate", Utilities_Business.formatData(getExpiryDate()));
    ...
    public JsonObject toJsonSoapVersion() {
        ...
        json.addProperty("expiryDate", Utilities_Business.formatDataToLong(getExpiryDate()));
        json.addProperty("parentIdTag",getParentIdTag());
        return json;
    }
}
