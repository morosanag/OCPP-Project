 ...
 */
@Entity
@Table(name = "AuthorizationStatus")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AuthorizationStatus.findAll", query = "SELECT a FROM AuthorizationStatus a"),
    @NamedQuery(name = "AuthorizationStatus.findByValue", query = "SELECT a FROM AuthorizationStatus a WHERE a.value = :value")})
