 ...
 * @author gabi
 */
public class Constants_Business {
    
    public static int HEARTBEAT_INTERVAL = 650;
    ...
    public static String DATE_FORMAT_MILIS_2 = "yyyy-MM-dd'T'hh:mm:ss'+00:00'";
    //2016-07-25T13:20:06.708Z
